# oh-my-cursor 架构文档：如何让 Cursor Agent 拥有工作流、角色和记忆 · 2026-04-04
...
本文是 oh-my-cursor（OMC）v0.1.0 的技术架构文档。如果[设计文档](./2026-04-04-oh-my-cursor-design-doc.md)回答的是 "为什么做" 和 "做什么"，这篇回答的是 "怎么做" 和 "代码在哪"。
...
>
> 设计文档：[oh-my-cursor 设计文档](./2026-04-04-oh-my-cursor-design-doc.md)
